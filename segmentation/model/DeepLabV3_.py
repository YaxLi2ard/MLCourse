...
class BackBone(nn.Module):
    def __init__(self, backbone):
        ...
        self.layer3 = self._modify_resnet_layer(backbone.layer3, dilate=[1, 1, 1, 1, 1, 1])
        self.layer4 = self._modify_resnet_layer(backbone.layer4, dilate=[1, 1, 1])
